...
void EditorLayer::OnAttach()
{
    ...
    JuicyEngine::FramebufferSpecification fbSpec;
    fbSpec.Width = 1280;
    fbSpec.Height = 720;
    m_Framebuffer = JuicyEngine::Framebuffer::Create(fbSpec);
}
void EditorLayer::OnDetach() {}
void EditorLayer::OnUpdate(JuicyEngine::Timestep ts)
{
    // Resize
    if (JuicyEngine::FramebufferSpecification spec = m_Framebuffer->GetSpecification();
    ...
    }
    {
        ...
        JuicyEngine::Renderer2D::DrawQuad({0.5f, -0.5f}, {0.5f, 0.75f}, m_SquareColor);
...
void EditorLayer::OnImGuiRender()
{
    ...
    if (ImGui::BeginMenuBar())
    {
        if (ImGui::BeginMenu("File"))
        {
            ...
            if (ImGui::MenuItem("Exit")) JuicyEngine::Application::Get().Close();
            ImGui::EndMenu();
        }
        ImGui::EndMenuBar();
    }
...
void EditorLayer::OnEvent(JuicyEngine::Event& e)
{

...
#include "JuicyEngine/Scene/SceneSerializer.h"
#include "JuicyEngine/Utils/PlatformUtils.h"
#include "ImGuizmo.h"
#include "JuicyEngine/Math/Math.h"
...
void EditorLayer::OnEvent(Event& e)
{
    ...
    dispatcher.Dispatch<KeyPressedEvent>(JE_BIND_EVENT_FN(EditorLayer::OnKeyPressed));
    dispatcher.Dispatch<MouseButtonPressedEvent>(JE_BIND_EVENT_FN(EditorLayer::OnMouseButtonPressed));
}

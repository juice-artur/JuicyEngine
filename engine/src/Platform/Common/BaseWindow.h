...
public:
	 ...
	 */
	virtual bool Create(const char* InTitle, unsigned int InWidth, unsigned int InHeight, unsigned int InFlags = SW_Default) = 0;
	 ...
	 */
	virtual bool PollEvent(WindowEvent& OutWindowEvent) const = 0;
	 ...
	 */
	virtual void GetSize(unsigned int& OutWidth, unsigned int& OutHeight) const = 0;

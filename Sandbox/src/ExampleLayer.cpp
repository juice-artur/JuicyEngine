...
ExampleLayer::ExampleLayer() : Layer("ExampleLayer"), m_CameraController(1280.0f / 720.0f)
{
    ...
    float vertices[3 * 7] = {
        -0.5f, -0.5f, 0.0f, 0.8f, 0.2f, 0.8f, 1.0f, 0.5f, -0.5f, 0.0f, 0.2f, 0.3f, 0.8f, 1.0f, 0.0f, 0.5f, 0.0f, 0.8f, 0.8f, 0.2f, 1.0f};
    ...
    JuicyEngine::Ref<JuicyEngine::IndexBuffer> indexBuffer = JuicyEngine::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
    ...
    JuicyEngine::Ref<JuicyEngine::IndexBuffer> squareIB = JuicyEngine::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
    ...
    m_ChernoLogoTexture = JuicyEngine::Texture2D::Create("assets/textures/ChernoLogo.png");
    textureShader->Bind();
    textureShader->SetInt("u_Texture", 0);
}
void ExampleLayer::OnAttach() {}
void ExampleLayer::OnDetach() {}
void ExampleLayer::OnUpdate(JuicyEngine::Timestep ts)
{
    // Update
...
void ExampleLayer::OnEvent(JuicyEngine::Event& e)
{
